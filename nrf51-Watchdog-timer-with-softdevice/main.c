 ...
 * It is an add on to the ble_app_template in the nRF51 SDK. If you want to see
 * what has been added to the original ble_app_template in order to add the watchdog
 * functionality, you can compare this file with the original file in the nRF51 SDK,
 * with e.g. WinDiff.
 *
...
#define WATCHDOG_RELOAD_PIN             BUTTON_3	//WDT
...
static void button_event_handler(uint8_t pin_no)
{
    switch (pin_no)
    {
        case WATCHDOG_RELOAD_PIN:
            nrf_gpio_pin_toggle(LED_3);  //Blink led to indicate button press
...
static void buttons_init(void)
{
    ...
    static app_button_cfg_t buttons[] =
    {
        ...
        {WATCHDOG_RELOAD_PIN,     false, NRF_GPIO_PIN_NOPULL, button_event_handler}
    };
...
int main(void)
{
    ...
    advertising_start();
		...
		for(i=0;i<NR_OF_STARTUP_BLINKS;i++)					
		{
